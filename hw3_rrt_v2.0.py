...
class RoboHandler:
  ...
  def run_problem_rrt(self):
    ...
    with self.env:
      ...
      #self.robot.SetActiveDOFValues([1.83728186, -0.98334683, 0.6 ,  2.01536424,  0.97461756,-0.96979975, -1.33875245])

    # get the trajectory!
    print "Finding the trajectory"
...
#    return goal_dofs
  ...
  # ASSUME INPUT VARIABLES AS TUPLE OR LIST
